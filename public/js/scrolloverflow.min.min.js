...
/*!
  ...
  */
function(t,i){t.fp_scrolloverflow=function(){t.IScroll||(t.IScroll=module.exports);function s(){var s=this;function o(){fp_utils.hasClass(i.body,"fp-responsive")?r(h):r(n)}function n(t){if(!fp_utils.hasClass(t,"fp-noscroll")){fp_utils.css(t,{overflow:"hidden"});var i,o=s.options.scrollOverflowHandler,n=o.wrapContent(),r=fp_utils.closest(t,".fp-section"),h=o.scrollable(t),a=function(t){var i=fp_utils.closest(t,".fp-section");return null!=i?parseInt(getComputedStyle(i)["padding-bottom"])+parseInt(getComputedStyle(i)["padding-top"]):0}(r);null!=h?i=o.scrollHeight(t):(i=t.scrollHeight,s.options.verticalCentered&&(i=e(".fp-tableCell",t)[0].scrollHeight));var l=fp_utils.getWindowHeight(),c=l-a;i+a>l?null!=h?o.update(t,c):(s.options.verticalCentered?(fp_utils.wrapInner(e(".fp-tableCell",t)[0],n.scroller),fp_utils.wrapInner(e(".fp-tableCell",t)[0],n.scrollable)):(fp_utils.wrapInner(t,n.scroller),fp_utils.wrapInner(t,n.scrollable)),o.create(t,c,s.iscrollOptions)):o.remove(t),fp_utils.css(t,{overflow:""})}}function r(t){e(".fp-section").forEach((function(i){var s=e(".fp-slide",i);s.length?s.forEach((function(i){t(i)})):t(i)}))}function h(t){var i=s.options.scrollOverflowHandler;fp_utils.hasClass(fp_utils.closest(t,".fp-section"),"fp-auto-height-responsive")&&i.remove(t)}s.options=null,s.init=function(e,n){return s.options=e,s.iscrollOptions=n,"complete"===i.readyState&&(o(),fullpage_api.shared.afterRenderActions()),t.addEventListener("load",(function(){o(),fullpage_api.shared.afterRenderActions()})),s},s.createScrollBarForAll=o,s.createScrollBar=n}IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var e=null,o=null,n={refreshId:null,iScrollInstances:[],lastScrollY:null,hasBeenInit:!1,iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(i){e=fp_utils.$,o=i;var r="ontouchstart"in t||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints;return n.iscrollOptions.click=r,n.hasBeenInit=!0,n.iscrollOptions=fp_utils.deepExtend(n.iscrollOptions,i.scrollOverflowOptions),(new s).init(i,n.iscrollOptions)},toggleWheel:function(t){e(".fp-scrollable",e(".fp-section.active")[0]).forEach((function(i){var s=i.fp_iscrollInstance;null!=s&&(t?s.wheelOn():s.wheelOff())}))},setIscroll:function(t,i){if(n.hasBeenInit&&t){var s=fp_utils.closest(t,".fp-scrollable")||e(".fp-scrollable",t)&&e(".fp-scrollable",t)[0],o=i?"enable":"disable";s&&s.fp_iscrollInstance[o]()}},onLeave:function(){n.toggleWheel(!1)},beforeLeave:function(){n.onLeave()},afterLoad:function(){n.toggleWheel(!0)},create:function(t,i,s){e(".fp-scrollable",t).forEach((function(e){fp_utils.css(e,{height:i+"px"});var o=e.fp_iscrollInstance;null!=o&&n.iScrollInstances.forEach((function(t){t.destroy()})),o=new IScroll(e,s),n.iScrollInstances.push(o),fp_utils.hasClass(fp_utils.closest(t,".fp-section"),"active")||o.wheelOff(),e.fp_iscrollInstance=o}))},isScrolled:function(t,i){var s=i.fp_iscrollInstance;if(!s)return!0;if("top"===t)return s.y>=0&&!fp_utils.getScrollTop(i);if("bottom"===t){var e=n.lastScrollY===s.y;return n.lastScrollY=s.y,(e?1:0)+(0-s.y)+fp_utils.getScrollTop(i)+i.offsetHeight>=i.scrollHeight}},scrollable:function(t){return e(".fp-slides",t).length?e(".fp-scrollable",e(".fp-slide.active",t)[0])[0]:e(".fp-scrollable",t)[0]},scrollHeight:function(t){return e(".fp-scroller",e(".fp-scrollable",t)[0])[0].scrollHeight},remove:function(t){if(null!=t){var i=e(".fp-scrollable",t)[0];if(null!=i){var s=i.fp_iscrollInstance;null!=s&&s.destroy(),i.fp_iscrollInstance=null,fp_utils.unwrap(e(".fp-scroller",t)[0]),fp_utils.unwrap(e(".fp-scrollable",t)[0])}}},update:function(t,i){clearTimeout(n.refreshId),n.refreshId=setTimeout((function(){n.iScrollInstances.forEach((function(t){t.refresh(),fullpage_api.silentMoveTo(fp_utils.index(e(".fp-section.active")[0])+1)}))}),150),fp_utils.css(e(".fp-scrollable",t)[0],{height:i+"px"}),o.verticalCentered&&fp_utils.css(e(".fp-scrollable",t)[0].parentNode,{height:i+"px"})},wrapContent:function(){var t=i.createElement("div");t.className="fp-scrollable";var s=i.createElement("div");return s.className="fp-scroller",{scrollable:t,scroller:s}}};return{iscrollHandler:n}}()}(window,document);